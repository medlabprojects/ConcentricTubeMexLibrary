...
void printHelp()
{
   const char * helpMsg = "function [] = ThreeTubeMexAtS(T1,T2,T3,psiL,Beta)   \n"
                          "  Inputs:\n"
                          ...
                          "      sEval:positions to guarantee sampling\n"
                          "   Outputs: \n"
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )
{
   ...
   if ( nlhs == 1 )
   {
	  ...
	  sEval = GetSEval( prhs[6] );
	  
	  //mexPrintf("sEval = %f\n", *sEval);
	  
      auto ret1 = Kinematics_with_dense_output( cannula, q, OType(), n_normal_points, 0, *sEval );
